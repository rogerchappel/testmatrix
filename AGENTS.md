# Agent Operating Instructions for testmatrix

This file defines how AI agents and human maintainers should work in `testmatrix`.

## Project Context

- Project: `testmatrix`
- Repository: `rogerchappel/testmatrix`
