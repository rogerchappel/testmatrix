...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `testmatrix` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in testmatrix.
